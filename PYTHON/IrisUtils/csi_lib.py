...
class CalibCSI:
    ...
    '''
	This function sends a pilot from ref to all other antennas at once, and 
	schedules all other nodes to send pilots in turn to the ref. ref receives all, 
	remove the gaurd and create the output uplink vector
